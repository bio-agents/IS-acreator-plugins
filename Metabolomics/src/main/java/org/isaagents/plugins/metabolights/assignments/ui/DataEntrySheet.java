package org.isaagents.plugins.metabolights.assignments.ui;
...
import org.isaagents.isacreator.spreadsheet.*;
import org.isaagents.isacreator.spreadsheet.model.TableReferenceObject;
import org.isaagents.plugins.metabolights.assignments.IsaCreatorInfo;
import org.isaagents.plugins.metabolights.assignments.TableCellListener;
import org.isaagents.plugins.metabolights.assignments.actions.AutoCompletionAction;
import org.isaagents.plugins.metabolights.assignments.actions.CellToAutoComplete;
import org.isaagents.plugins.metabolights.assignments.actions.CopyPasteAdaptor;
import org.isaagents.plugins.metabolights.assignments.actions.SelectionRunner;
import org.isaagents.plugins.metabolights.assignments.io.ConfigurationLoader;
import org.isaagents.plugins.metabolights.assignments.io.FileLoader;
import org.isaagents.plugins.metabolights.assignments.io.FileWriter;
...
//    	}
    ...
    public void createTopPanel() {
        ...
        autocompleteCheck.setAgentTipText("Activate automatic metabolite search if you want to have related cells updated after a cell is edited");
        ...
        if (isVersion1File()){     //True if version 1, false if any new version
            autocompleteCheck.setAgentTipText(" NB! ONLY works with newer versions of the metabolite identification file. Please contact metabolights-help@ebi.ac.uk if you want an updated version for your study");
        ...
        getIdButton.setAgentTipText("Autocomplete other columns based on the current column looking up in PubChem.");
        ...
        importSpecieButton.setAgentTipText("Fill the columns [taxid] and [species] based on the data entered in the study sample.");
