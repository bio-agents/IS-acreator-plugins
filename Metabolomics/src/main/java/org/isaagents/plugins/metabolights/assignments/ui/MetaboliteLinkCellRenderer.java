...
import org.isaagents.isacreator.spreadsheet.SpreadsheetCellRenderer;
import org.isaagents.isacreator.spreadsheet.SpreadsheetFunctions;
import org.isaagents.plugins.metabolights.assignments.actions.AutoCompletionAction;
import org.isaagents.plugins.metabolights.assignments.model.RemoteInfo;
import org.isaagents.plugins.metabolights.assignments.model.RemoteInfo.remoteProperties;
	...
	public class MetaboliteLinkCellRenderer extends SpreadsheetCellRenderer implements MouseListener{
		...
		public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
			...
			if (canWeLinkIt(value.toString())){
				...
				setAgentTipText("To activate the link: Press \"Control Key\" while clicking with the mouse.");
			}else{
